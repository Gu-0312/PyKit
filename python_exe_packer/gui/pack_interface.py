...
class PackInterface(QWidget):
    ...
    def _build_ui(self):
        ...
        self.clear_deps_btn = PushButton(tr("clear_all"))
        self.clear_deps_btn.clicked.connect(lambda: self._clear_list(self.deps_list))
        dep_btn_row.addWidget(self.clear_deps_btn)
        ...
        self.clear_excl_btn = PushButton(tr("clear_all"))
        self.clear_excl_btn.clicked.connect(lambda: self._clear_list(self.excludes_list))
        excl_btn_row.addWidget(self.clear_excl_btn)
        ...
        self.clear_data_btn = PushButton(tr("clear_all"))
        self.clear_data_btn.clicked.connect(lambda: self._clear_list(self.data_list))
        data_btn_row.addWidget(self.clear_data_btn)
